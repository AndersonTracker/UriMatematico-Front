...
const EditTopics = () => {
    const [title] = useState("Editar tópico");
    ...
    function saveTopics(event) {
        ...
        if (Object.keys(newErrors).length === 0) {
            ...
            fetch(Variaveis.urlBase + ":8080/topics/" + id, {  // 123 é o ID do tópico que você está editando
    ...
    return (
        <>
            ...
            <div className='bodyTeacker'>
                <form className='formBodyTeacker' onSubmit={saveTopics}>
